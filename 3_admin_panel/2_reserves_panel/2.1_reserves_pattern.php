...
<form action="2.2_reserves_pattern.php" method="post" enctype="multipart/form-data" id="formID" ><!-- создаем форму для последующей отправки в php -->
<h2>Добавление шаблона ингредиента</h2><!-- Заголовок формы -->
<input type="text" id="l1" name="name" placeholder="Название.....(Должно быть уникальным"><!-- Поле для ввода названия нового объекта -->
<input type="text" id="l2" name="min_q" class='numberInput' placeholder="Минимальное количество товара.....(ввод только цифр)"><br><!-- Поле для ввода цены нового объекта -->
<input type="text" id="l3" name="max_q" class='numberInput' placeholder="Максимальное количество товара.....(ввод только цифр)"><br><!-- Поле для ввода цены нового объекта -->
<input type="text" id="l4" name="crit_q" class='numberInput' placeholder="Критическое количество товара.....(ввод только цифр)"><br><!-- Поле для ввода цены нового объекта -->
