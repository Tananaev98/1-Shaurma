...
//-------------------------------------------------------------Генерация блоков на каждый пункт меню---------------------------------------------------------------
    ...
    while ($row = pg_fetch_assoc($result)) {
        ...
        echo "<a href='' class='icon_edit_delete' title='Перейти к редактированию этого объекта меню'><img src='1_image/1_edit.png'></a>";//выводим изображение ссылку на сценарий удаления этого объекта      
