...
//передать идентификатор выбранного объекта меню
//передать идентификатор выбранного ингредиента из списка
//передать введенное количество
//сделать все это при нажатии кнопки создать
//подготовить и указать сценарий php который будет обрабатывать передаваемые значения и выполнять вставку данных
//после успешного выполнения вставки данных последовательно вызвать функции displayingSelect и displayingStocks
