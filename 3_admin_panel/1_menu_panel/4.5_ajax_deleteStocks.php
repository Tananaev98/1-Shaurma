...
$id = $_GET['id_reserves'];// Получаем значение 'id' из GET-запроса


$sql = "delete FROM requirement_reserves where id = $id;";// Выполняем запрос к базе данных для получения данных по выбранному значению
...
if ($result) {// Проверяем успешность выполнения запроса
 echo"Данные успешно удалены";//сообщение об успешном удалении данных
