...
function checkLogPass($log, $pass) {//функция ожидающая параметры логина и пароля
    ...
    //Если соединение установленно успешно продолжаем выполнение кода
        ...
        echo "Соединение с базой данных установлено успешно!2312313212";
        ...
        if (!$result){ echo "Ошибка выполнения запроса: " . pg_last_error($conn); }//проверяем выполнение запроса, в случае неудачи выводим подробную ошибку
            ...
            echo "$row[name], $row[family], $row[middlename] авторизован+dop proverka"; //Вывод сообщения подтверждающего успешную авторизацию   
            }
            else{ echo "Неверный логин или пароль"; } //Вывод сообщения в случае если нет совпадения по логину и паролю
            }
    }
